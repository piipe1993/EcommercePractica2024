#language: es
Característica: CASO0004 Crear Pedido desde Mis Productos

  @CASO0004 @crearPedidoMisProductos @EliteProfesional
  Esquema del escenario: Crear pedido a traves de Mis Productos
...
##@externaldata@./Data/DataElite.xlsx@DataPedidoMisProductos
