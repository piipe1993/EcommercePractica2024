...
public class CotizarUI extends PageObject {
    ...
    public static final Target LBL_NUEVA_COTIZACION = Target.the("Boton Nueva Cotizacion").locatedBy("//div[@class='rectangle'][descendant::div[contains(text(),' Nueva Cotización ')]]");
    public static final Target LBL_LISTADO_COTIZACIONES = Target.the("Boton Listado Cotizaciones").locatedBy("//div[@class='rectangle'][descendant::div[contains(text(),' Listado de Cotizaciones ')]]");
   ...
   public static final Target LBL_PRODUCTO_SELECCIONADO= Target.the("Etiqueta Producto Seleccionado").locatedBy("//div[@class='product'][ancestor::div[@class='productos ng-star-inserted']]");
    ...
    public static final Target BTN_CERRAR_COTIZACION_EXITOSA= Target.the("Boton Cerar PopPup Cotizacion Exitosa").locatedBy("//span[contains(text(),'X')][ancestor::div[@class='boton-cerrar-dialog color-fuente-dialog']]");
