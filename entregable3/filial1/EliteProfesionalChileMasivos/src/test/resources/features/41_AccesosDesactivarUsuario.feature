...
##@externaldata@./Data/DataElite.xlsx@41_BloquearAcceso
   |https://clmspa.cwgpxw02kj-empresasc1-s1-public.model-t.cc.commerce.ondemand.com/loginn   |julian.farias+22@avvale.com   |Compras01*   |154631   |robot_clm   |andrestest3@softys.com|
