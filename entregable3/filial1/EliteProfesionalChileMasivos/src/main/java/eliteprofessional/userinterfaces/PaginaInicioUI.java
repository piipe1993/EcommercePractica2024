...
public class PaginaInicioUI extends PageObject {
    ...
    public static final Target OPCION_MI_CUENTA = Target.the("Opcion para acceder al menu Mi cuenta").locatedBy("(//div[@class='customCmsMyAccount']//img)[2]");
    public static final Target OPCION_ORDEN_RAPIDA = Target.the("Opcion para crear orden rapida dentro Menu mi cuenta").locatedBy("(//a[@href='/my-account/quick-order'])[3]");
