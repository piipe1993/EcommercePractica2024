...
public class FinalizacionCompraUI extends PageObject {
    ...
    public static final Target INPUT_COMENTARIOS = Target.the("Campo Comentarios").locatedBy("//textarea[@placeholder='Observaciones de entrega, etc.']");

    public static final Target LBL_COMPRA_RECIBIDA= Target.the("Etiqueta Compra Recibida").locatedBy("//div[@class='purchaseLine' and contains(text(),'Compra Recibida')]");
    ...
    public static final Target INPUT_OC_FILE = Target.the("Input para subir OC").locatedBy("//input[@type='file']");

    public static final Target LBL_OC_FILE = Target.the("Label OC").locatedBy("//*[contains(text(),'OC.pdf')]");

    public static final Target BTN_PROXIMO_MES = Target.the("Boton Proximo Mes").locatedBy("//button[@aria-label='Next month']");

    public static final Target OPCIÓN_VER_PEDIDO_GENERADO = Target.the("Opción ir a pedido generado").located(By.className("puntero-aqui"));

    public static final Target LBL_NUMERO_PEDIDO = Target.the("Label numero pedido generado").locatedBy("//div[contains(@class,'purchaseMB d-block')]/following-sibling::div[1]");

    public static final Target TITULO_PEDIDO_GENERADO = Target.the("Opción ir a pedido generado").located(By.className("titleTxt"));
