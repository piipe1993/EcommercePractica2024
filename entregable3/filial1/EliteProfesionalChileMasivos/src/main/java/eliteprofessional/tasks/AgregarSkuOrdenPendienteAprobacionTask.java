...
import static eliteprofessional.userinterfaces.CarritoDeComprasUI.POPUP_ERROR_FINALIZAR_COMPRA;
...
public class AgregarSkuOrdenPendienteAprobacionTask implements Task {
    ...
    public AgregarSkuOrdenPendienteAprobacionTask(String cantidad, String SKU) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        ValidarError.validar(localizador);
    ...
    public static Performable ir (String cantidad, String SKU) {
        return Instrumented.instanceOf(AgregarSkuOrdenPendienteAprobacionTask.class).withProperties(cantidad,SKU);
    }
}
