...
public class IngresarOrdenRapidaRepetirPedidoTask implements Task {

    String pedido;

    public IngresarOrdenRapidaRepetirPedidoTask(String pedido) {
        this.pedido = pedido;
    }
    ...
    public static IngresarOrdenRapidaRepetirPedidoTask conPedido(String pedido) {
        return instrumented(IngresarOrdenRapidaRepetirPedidoTask.class, pedido);
    }
}
