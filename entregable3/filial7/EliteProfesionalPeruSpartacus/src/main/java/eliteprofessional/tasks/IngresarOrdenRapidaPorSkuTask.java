...
public class IngresarOrdenRapidaPorSkuTask implements Task {

    String sku;
    String cantidad;

    public IngresarOrdenRapidaPorSkuTask(String sku, String cantidad) {
        this.sku = sku;
 ...
 public static IngresarOrdenRapidaPorSkuTask conDatos(String sku, String cantidad){
        return instrumented(IngresarOrdenRapidaPorSkuTask.class, sku, cantidad);
 }
}
