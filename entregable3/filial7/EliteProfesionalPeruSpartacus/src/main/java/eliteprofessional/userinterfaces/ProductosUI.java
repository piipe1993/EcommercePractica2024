...
public class ProductosUI extends PageObject {
    ...
    public static Target LBL_PRODUCTO_BONIFICADO (String SKU){
        return Target.the("LBL Producto Bonificado con SKU: "+ SKU).locatedBy("//div[contains(@class,'freeGoods')][(preceding::div[4][contains(text(),'"+ SKU +"')])and(ancestor::main)]");
    }

    public static Target LBL_PRODUCTO_BONIFICADO_SIN_STOCK (String SKU){
        return Target.the("LBL Producto Bonificado sin Stock con SKU: "+ SKU).locatedBy("//div[contains(@class,'freeGoods')][(preceding::div[6][contains(text(),'"+ SKU +"')])and(ancestor::main)]");
    }

    public static final Target LBL_PRODUCTO_BONIFICADO_DETALLE = Target.the("LBL Detalle Producto Bonificado").locatedBy("//div[@class='freeGoods d-none d-md-block ng-star-inserted']");
